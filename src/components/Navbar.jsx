...
export default function Navbar() {
  ...
  const { sections, activeSection, matrixEnabled, toggleMatrix } =
  ...
  return (
    <nav className="navbar" ref={navRef} aria-label="Primární navigace">
      ...
      {/* Přepínače tématu a jazyka — vždy na desktopu */}
      <div className="navbar-center desktop navbar-switchers">
        <ThemeToggle />
        <LanguageSwitcher
